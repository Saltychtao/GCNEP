...
class RGCN(BaseRGCN):
    ...
    def build_hidden_layer(self, idx):
        ...
        return RGCNTransLayer(in_feat=self.h_dim,out_feat=self.h_dim,num_rels=self.num_rels,rel_dim=self.h_dim,activation=act,self_loop=False,dropout=self.dropout)
